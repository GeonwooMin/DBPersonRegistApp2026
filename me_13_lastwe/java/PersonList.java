...
import com.example.dbpersonregistapp2026.databinding.ActivityMainBinding;
...
public class PersonList extends AppCompatActivity {
    ...
    DBManager dbManager;
    SQLiteDatabase sqlite;  // 휴대폰에 기본적으로 들어있는 데이터 베이스

    String str_name="", str_stdno="", str_grade="";
    String str_hobby="", str_major="", str_phone="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            while(cursor.moveToNext()){
                ...
                //str_name= cursor.getString(cursor.getColumnIndex("name"); 같은거임, 이번에는 윗 줄의 타입으로 감
                ...
                tv_name.setBackgroundColor(Color.argb(50,0,120,255));
            ...
            Toast.makeText(getApplicationContext(), "DB접근 오류", Toast.LENGTH_SHORT).show();
        }
