...
public class PersonRegist extends AppCompatActivity {
    ...
    public final static int REQUEST_PHOTO_CODE = 1; //REQUEST_PHOTO_CODE 등록

    String[] majorlist={"영상미디어콘텐츠과","컴퓨터공학과","사회복지과","항공운항과","게임콘텐츠과"};
    String[] arealist={"평택시","화성시","수원시","인천광역시","서울특별시"};
    Spinner major,area;
    ...
    String str_name,str_stdno,str_myPhone,str_grade,str_one,str_two,str_three,
            str_hobby,str_hobby01,str_hobby02,str_hobby03,str_uri,str_major,str_area;
    String str_photoUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter area_adapter = new ArrayAdapter(this,android.R.layout.simple_spinner_item,arealist);
        area_adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);
        ...
        findImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(iit,REQUEST_PHOTO_CODE); //상단에 REQUEST_PHOTO_CODE 등록 필요
        ...
        registBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                    dbManager = new DBManager(PersonRegist.this);
                    ...
                    sqLiteDB.close();
                    dbManager.close();
                    Toast.makeText(getApplicationContext(),"회원 추가 성공",Toast.LENGTH_SHORT).show();

                }catch(SQLException e){
                    Toast.makeText(getApplicationContext(),"회원 추가 실패",Toast.LENGTH_SHORT).show();
                }
    ...
    public void onActivityResult(int requestcode, int resultcode, Intent it){
        ...
        if(requestcode==REQUEST_PHOTO_CODE){
            ...
            Toast.makeText(getApplicationContext(),"사진 선택 오류",Toast.LENGTH_SHORT);
        }
    }
